...
## Overview
<div style="text-align:center"><img src="http://i.imgur.com/3dyjJbn.jpg" /> <img src="http://i.imgur.com/QZx76xk.jpg" /></div>
...
<div style="text-align:center"><img src="https://i.imgur.com/PXNT7Vv.jpg" /></div>
...
| Oneirocritica 					| Effect Monster  | WIND FAIRY         | 200/100   | If your opponent controls a monster and you control no monsters, you can Special Summon this card (from your hand). Once per turn: You can declare a Level from 1 to 5: this card becomes that Level until the End Phase. |
...
| Unconscious Beast 				| Effect Monster  | EARTH FAIRY        | 0/0       | You can banish this card from your Graveyard to target 1 FAIRY-Type Monster in your Graveyard; Special Summon it. You cannot Special Summon for the rest of the turn. |
| Ghost				 				| Effect Monster  | LIGHT FAIRY        | 0/0       | This card cannot be destroyed by battle. If this card is sent to the Graveyard as a Fusion Material for a Fusion Summon: You can target 1 "Polymerization" in your Graveyard: add it to your hand. |
...
| Name        						| Type			  | Attribute & Type	   | ATK/DEF   | Effect			   |
| :-------------------------------: | :------------: | :----------------:  | :-------: | :---------------: |
| Connection Inflicter				| Fusion Monster  | DARK FAIRY         | 1500/1000 | "Dreamstride - Nightmare Inflicter" + "Dreamstride - Insomnia" - When this card is Special Summoned: You can add 1 Spell Card from your Graveyard to your hand. If this card is used for a Synchro Summon and sent to the Graveyard: draw 1 card. This card cannot be used as a Synchro Material Monster, except for the Synchro Summon of a FAIRY-type monster.  |
| Conscious Revival   				| Fusion Monster  | DARK FAIRY         | 1800/300  | "Dreamstride - Nightmare Inflicter" + "Dreamstride - Conscious" - Once per turn: You can target 1 Level 3 of lower FAIRY monster in your Graveyard; send 1 card from your hand to your Graveyard, and if you do, Special Summon that target. If this card is used for a Synchro Summon and sent to the Graveyard: draw 1 card. This card cannot be used as a Synchro Material Monster, except for the Synchro Summon of a FAIRY-type monster.  |
| Crippling Voices    				| Fusion Monster  | DARK FAIRY         | 1500/300  | "Dreamstride - Voices in my Head" + "Dreamstride - Insomnia" - During either player's turn: You can target 1 face-up monster your opponent controls; this card loses 500 ATK and that monster loses 500 ATK. If this card is used for a Synchro Summon and sent to the Graveyard: draw 1 card. This card cannot be used as a Synchro Material Monster, except for the Synchro Summon of a FAIRY-type monster.  |
...
| Rhythem             				| Synchro Monster | LIGHT FAIRY        | 2500/350  | 1 Tuner Fusion Monster + 1 or more non-Tuner Monsters. - When this card is Synchro Summoned: Draw 1 card. This card can attack all Special Summoned monsters your opponent controls, once each. |
