...
| :-------------------------------: | :------------: | :----------------:  | :-------: | :---------------: |
| Dreamstride - Insomnia 			| Effect Monster  | DARK FAIRY         | 1100/300  | You can discard 1 card to Special Summon this card from your hand. If this card is sent to the Graveyard for the Synchro Summon of a LIGHT Synchro Monster, you can destroy 1 Spell or Trap Card |
| Dreamstride - Conscious 			| Effect Monster  | LIGHT FAIRY        | 1200/100  | You can discard this card to the Graveyard: Add 1 "Polymerization" from your Deck or Graveyard to your hand. When this card is Special Summoned: You can add 1 FAIRY monster from your Deck to your hand. |
| Dreamstride - Nightmare Inflicter | Effect Monster  | DARK FAIRY         | 1000/0    | If this card attacks, your opponent cannot activate any Spell or Trap Cards until the end of the Damage Step. If this card is in your Graveyard: You can Special Summon this card. You must control a Tuner monster to activate and to resolve this effect |
...
| Dreamstride - Solid Soul 			| Effect Monster  | DARK FAIRY         | 0/1700    | When a Level 3 or lower monster(s) is Special Summoned (except during the Damage Step): You can Special Summon this card from hand. If this card is sent to the Graveyard for a Synchro Summon or Fusion Summon of a FAIRY monster, draw 1 card. |
| Dreamstride - Unconscious Beast 	| Effect Monster  | EARTH FAIRY        | 0/0       | If this card is in the Graveyard: You can send the top card of your Deck to Graveyard, and if you do, Special Summon this card. Once this effect has been activated: You cannot Special Summon for the rest of the turn. |
...
| Dreamstride - Witch 				| Effect Monster  | DARK FAIRY         | 900/1100  | If you control a FAIRY monster other than "Dreamstride - Witch", you can Special Summon this card (from your hand). You can substitute this card for any 1 Fusion Material Monster, but the other Fusion Material Monster(s) must be correct. |
...
| Dreamstride - Connection Inflicter| Fusion Monster  | DARK FAIRY         | 2500/1000 | "Dreamstride - Nightmare Inflicter" + "Dreamstride - Insomnia" - When this card is Special Summoned: You can add 1 Spell Card from your Graveyard to your hand. |
| Dreamstride - Conscious Revival   | Fusion Monster  | DARK FAIRY         | 1800/300  | "Dreamstride - Nightmare Inflicter" + "Dreamstride - Conscious" - Once per turn: You can target 1 Level 3 of lower FAIRY monster in your Graveyard; send 1 card from your hand to your Graveyard, and if you do, Special Summon that target. |
| Dreamstride - Crippling Voices    | Fusion Monster  | DARK FAIRY         | 1500/300  | "Dreamstride - Voices in my Head" + "Dreamstride - Insomnia" - During either player's turn: You can target 1 face-up monster your opponent controls; this card loses 500 ATK and that monster loses 500 ATK. |
| Dreamstride - Nightmare Conscious | Fusion Monster  | DARK FAIRY         | 2300/1200 | "Dreamstride - Nightmare Inflicter" + "Dreamstride - Conscious" - If this card is destroyed by a card effect: Destroy all cards on the field. |
...
| Dreamstride - Crescent Owl        | Fusion Monster  | DARK FAIRY         | 800/1400  | "Dreamstride - Oneirocritica" + "Dreamstride - Insomnia" - Twice per turn, this card cannot be destroyed by battle. Once per turn: You can declare a Level from 1 to 6; this card becomes that Level until the End Phase. |
| Dreamstride - Inner Loathe        | Fusion Monster  | DARK FAIRY         | 800/1400  | "Dreamstride - Voices in my Head" + "Dreamstride - Hangman" - All Battle Damage to either player from battle involving this monster becomes 0. During the End Phase, if this card was destroyed by battle and sent to the Graveyard this turn: Special Summon this card from the Graveyard. If you use this card you control for a Synchro Summon, you can treat it as a non-Tuner monster. |
